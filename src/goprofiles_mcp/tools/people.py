...
def _format_person(p: PersonResult, *, show: set[str], show_match: bool) -> str:
    lines = [
        ...
        # uid is for get_profile / create_bravo — never repeat it in user-facing replies.
...
async def search_people(
    ...
    The 'uid' is an internal id for calling get_profile, create_bravo (as
    ...
    if names and len(data.results) > 1:
        footer = (
            ...
            "right uid for get_profile or create_bravo, and confirm with the user "
